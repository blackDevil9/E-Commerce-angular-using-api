...
var ng8_breadcrumb_1 = require("ng8-breadcrumb");
    ...
    CoreModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                test_error_component_1.TestErrorComponent,
            ...
            imports: [
                ...
                ng8_breadcrumb_1.Ng8BreadcrumbModule.forRoot({
                    prefix: 'Home' // default 'false'
                }),
            ],
            exports: [nav_bar_component_1.NavBarComponent, section_header_component_1.SectionHeaderComponent]
        })
    ], CoreModule);
    return CoreModule;
}());
